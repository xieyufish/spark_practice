...
/**
 * Apache日志处理
 * 统计每个用户在不同机器(ip)访问请求同一个资源的次数及访问流量
...
public class LogQuery {
	...
	public static void main(String[] args) {
		SparkSession spark = SparkSession.builder().appName("LogQuery").getOrCreate();
		...
		JavaPairRDD<Tuple3<String, String, String>, Stats> extracted = dataSet
				.mapToPair(new PairFunction<String, Tuple3<String, String, String>, Stats>() {
					...
					@Override
					public Tuple2<Tuple3<String, String, String>, Stats> call(String t) throws Exception {
						return new Tuple2<>(extractKey(t), extractStats(t));
					}
